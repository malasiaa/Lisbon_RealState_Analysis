...
url = 'https://www.idealista.pt/comprar-casas/lisboa/com-t1'
...
while True:
    ...
    url = f'https://www.idealista.pt/comprar-casas/lisboa/com-t1/pagina-{x}'
    browser.get(url)
...
ids_houses.to_csv(r'C:\Users\josej\Programming for Data Science\Programming Course\Group project\ids_houses_T1.csv', index = False)
...
df_houses.to_csv(r'C:\Users\josej\Programming for Data Science\Programming Course\Group project\houses_T1.csv', index = False)