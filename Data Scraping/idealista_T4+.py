...
url = 'https://www.idealista.pt/comprar-casas/lisboa/com-t3'
...
while True:
    ...
    url = f'https://www.idealista.pt/comprar-casas/lisboa/com-t4-t5/pagina-{x}'
    browser.get(url)
...
ids_houses.to_csv(r'C:\Users\josej\Programming for Data Science\Programming Course\Group project\ids_houses.csv', index = False)
...
df_houses.to_csv(r'C:\Users\josej\Programming for Data Science\Programming Course\Group project\houses2.csv', index = False)